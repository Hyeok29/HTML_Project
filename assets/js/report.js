var rdscpu_data = (
    [
      ...
      },
      {
        "id": 2,
        "time": "01:00",
        "resource": "sigrrow-test-mariadb 2",
        "current_avg": "4.00",
        "current_max": "10.01",
        "yesterday_avg": "30.00",
        "yesterday_max": "30.01",
...
$(function () {
  ...
  var $rds_dbc_stroke_color2 = '#ebf0f7';
  var $rds_dbc_chart = document.querySelector('#rds_dbc_chart');
  var rds_dbc_chart_option;
  var rds_dbc_chart;
// RDS ------------------------------------------------------------------
...
//--------------- RDS DB Connection Chart ---------------
  ...
  rds_dbc_chart = new ApexCharts($rds_dbc_chart, rds_dbc_chart_option);
  rds_dbc_chart.render();
